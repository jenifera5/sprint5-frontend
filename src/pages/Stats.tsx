          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 mb-8">
              {popularBooks.map((book) => {
                const percentage = maxPrestamos > 0 ? (book.prestamos_count / maxPrestamos) * 100 : 0;
                return (
                  <div key={book.id}>
                    ...
                    <div className="flex items-center gap-2">
                      <div className="h-2 w-16 bg-purple-100 rounded-full overflow-hidden">
                        <div 
                          ...
                          style={{ width: `${maxPrestamos > 0 ? (book.prestamos_count / maxPrestamos) * 100 : 0}%` }}
                        />
                      </div>
